...
### 🛠 What I'm working on
- **Boxde (todo-information-board)**: Box APIを活用した、Mac/Windows間を跨ぐマルチプラットフォームTo-Doアプリ
- **Tax Calculation App**: 副業や個人開発者向けの確定申告サポートツール

### 🚀 Interests
- **Local LLMs**: ローカル環境での大規模言語モデルの構築・活用
- **AI Automation**: AIを活用した業務効率化とスライド作成術
- **Video Production**: 放送・ポストプロダクションシステムの最適化
